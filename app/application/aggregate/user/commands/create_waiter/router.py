...
@router.post("/waiter", response_model=Response, status_code=status.HTTP_201_CREATED)
async def create_waiter(request: Request, session: Meta = Depends(get_session_meta)) -> Response:
