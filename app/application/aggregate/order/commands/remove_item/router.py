...
@router.delete("/{order_id}/items/{item_id}", response_model=Response, status_code=status.HTTP_200_OK)
async def remove_item(order_id: UUID, item_id: UUID, session: Meta = Depends(get_session_meta)) -> Response:
